    ...
    <div className="px-4 py-28 mx-auto max-w-4xl sm:px-6 lg:px-8">
      ...
      <div className="space-y-8 leading-relaxed text-slate-300">
        <section>
          ...
          <p>
            Les presentes conditions definissent les regles d&apos;utilisation du
            site {BRAND_NAME}. En accedant au site, vous acceptez ces
            conditions.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            sont proteges. Toute reproduction ou reutilisation sans autorisation
        ...
        <section>
          ...
          <p>
            ...
            absolue n&apos;est donnee sur l&apos;absence d&apos;erreurs, d&apos;interruptions ou de
            pertes de donnees.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Le site peut contenir des liens vers des ressources tierces. Nous ne
